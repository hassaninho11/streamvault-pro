    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      ...
      <div className="flex items-center gap-3 mb-8 z-10">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">IPTV Player</p>
        </div>
      </div>

      {/* Benefits of account */}
      <div className="mb-6 flex flex-wrap justify-center gap-4 text-sm text-muted-foreground z-10">
      ...
      {/* Auth Card */}
      <Card variant="glass" className="w-full max-w-md z-10">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {activeTab === "login" 
              ? "Sign in to sync your channels and settings" 
