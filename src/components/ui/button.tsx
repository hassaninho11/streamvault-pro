  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // StreamVault custom variants
        glow:
          "bg-primary text-primary-foreground shadow-glow hover:shadow-glow-lg hover:bg-primary/90 active:scale-[0.98]",
        glass:
          "glass-card text-foreground hover:bg-card/80 border-border/50",
        player:
          "bg-player-controls/80 text-foreground hover:bg-primary hover:text-primary-foreground rounded-full",
        nav:
          "justify-start text-muted-foreground hover:text-foreground hover:bg-muted w-full",
        navActive:
          "justify-start bg-primary/10 text-primary hover:bg-primary/20 w-full shadow-[inset_3px_0_0_hsl(var(--primary))]",
        premium:
